...
const Product = () => {
    ...
    //object.keys gives an objects owns keys as arrays and here we check if there are empty or not
    
    if(!Object.keys(product).length > 0) return<h1>Not Found</h1>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        {/**object chaining to access an objects property*/}
